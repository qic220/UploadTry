...
cell = pyphase.crystal.CellTools.scale_by(pyphase.crystal.CellTools.tile(pyphase.crystal.CellCodecs.read_lammps('NaCl.dat'), (4, 4, 4)), 1.0)

pyphase.crystal.CellCodecs.write_xyz(cell,'nacl.xyz')
